...
export async function fetchRawAnalyticsData(supabase, from, to) {
  ...
  const sessionSelect = hasAiCols
    ? "session_id, visitor_id, started_at, last_activity_at, device_type, traffic_source, referrer, browser, operating_system, country, city, utm_source, utm_medium, utm_campaign, ai_platform, ai_attribution_type"
    : "session_id, visitor_id, started_at, last_activity_at, device_type, traffic_source, referrer, browser, operating_system, country, city, utm_source, utm_medium, utm_campaign";
