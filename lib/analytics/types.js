...
/**
 * @typedef {Object} PartnerTrackerItem
 * @property {string} id - Partner ID ("rng_gamez" | "murakkaz")
 * @property {string} name - Partner name ("RNG Gamez" | "Murakkaz")
 * @property {string} partnerDomain - Associated domain
 * @property {string} trackingUrl - Inbound tracking URL
 * @property {string} displayParam - Short parameter badge
 * @property {string} category - Category tag
 * @property {string} description - Partner description
 * @property {string} themeColor - Accent color hex
 * @property {string} badgeText - Badge text
 * @property {number} visitors - Unique visitor count
 * @property {number} sessions - Legitimate session count
 * @property {number} pageviews - Total pageview count
 * @property {number} avgDurationSeconds - Average duration in seconds
 * @property {string} avgDurationFormatted - Formatted duration string
 * @property {number} conversions - Inquiries / leads count
 * @property {string} conversionRate - Percentage string
 * @property {string} bounceRate - Percentage string
 * @property {boolean} isLive - Active in last 5 minutes
 * @property {string|null} latestActivity - ISO timestamp of latest visit
 * @property {Array<{ path: string, views: number }>} topPages - Top visited pages
 * @property {{ desktop: number, mobile: number, tablet: number }} devices - Device breakdown
 * @property {Array<Object>} recentSessions - Recent session records
 */
 ...
 * @property {PartnerTrackerItem[]} partnerTrackers - Dedicated partner link tracking metrics
 */
