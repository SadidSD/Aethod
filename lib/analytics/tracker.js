...
import { detectAiReferral, AI_ATTRIBUTION_TYPES } from "./aiPlatforms.js";
...
class AnalyticsTracker {
  ...
  trackPageView(path, search = "") {
    ...
    const aiDetection = detectAiReferral(rawReferrer, activeSearch);
    const currentTrafficSource = classifyTrafficSource(
      rawReferrer,
      activeSearch,
